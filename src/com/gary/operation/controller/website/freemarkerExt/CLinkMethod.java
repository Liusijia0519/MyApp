...
public class CLinkMethod implements TemplateMethodModelEx{
	@Autowired
	...
	public Object exec(List args) throws TemplateModelException {
		...
		SystemDictionary sysdic = service.getSimpleCategoryByID(args.get(0).toString());
		
		return "home.do?method=list&CategoryID="+sysdic.getId(); 
